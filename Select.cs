...
namespace VMS.TPS
{
    ...
    public class SelectBox
    {
        ...
        private GroupBox InitializeRadioButtons(List<String> list, String groupTitle)
        {
            ...
            foreach (String item in list )
            {
                ...
                rdbuttonList.Last().Size = new System.Drawing.Size(140, 17);
            ...
            groupBox1.Size = new System.Drawing.Size(220, 40 + 30 * i);
            groupBox1.Text = groupTitle;

            this.my_form.Location = new System.Drawing.Point(100, 100);
            this.my_form.ClientSize = new System.Drawing.Size(292, 200 + 25 * i);
    ...
    public class SelectOneStruct
    {
        ...
        public SelectOneStruct(String title, PlanSetup my_plan, IEnumerable<Structure> set_of_structs)
        {
            this.title = title;
        ...
        public Structure Get_Selected()
        {
            ...
            return my_plan.StructureSet.Structures.Where(s => s.Id.Equals(selected)).First();
        }
